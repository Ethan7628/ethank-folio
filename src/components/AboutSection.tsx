          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <Card key={index} className="glass-effect border-0 text-center p-4">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              {milestones.map((milestone, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-cyber-blue to-cyber-purple rounded-full flex items-center justify-center">
